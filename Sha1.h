...
constexpr auto one_block_size_bytes = 64; // количество байт в блоке
constexpr auto one_block_size_uints = 16; // количество 4байтовых в блоке
constexpr auto block_expend_size_uints = 80; // количество 4байтовых в дополненном блоке
